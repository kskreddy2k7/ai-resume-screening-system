...
export default function ProfessionalTemplate() {
  ...
  const layout = data.layout || { fontFamily: 'Times New Roman, serif', fontSize: 13, primaryColor: '#000000', lineSpacing: 1.5, margins: 20 };

  const renderSection = (sectionId: string) => {
    switch (sectionId) {
      case 'personalInfo':
        return (
          <div className="text-center mb-6 border-b-2 border-black pb-4" key="personalInfo">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-2 text-[13px] text-gray-900 font-medium">
      ...
      case 'summary':
        ...
        return (
          <div className="mb-5" key="summary">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-2 text-black tracking-wider">Professional Summary</h2>
      ...
      case 'experience':
        ...
        return (
          <div className="mb-5" key="experience">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-3 text-black tracking-wider">Experience</h2>
      ...
      case 'education':
        ...
        return (
          <div className="mb-5" key="education">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-3 text-black tracking-wider">Education</h2>
      ...
      case 'skills':
        ...
        return (
          <div className="mb-5" key="skills">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-2 text-black tracking-wider">Skills & Interests</h2>
            <div className="text-[13px] text-gray-950 leading-relaxed flex flex-wrap gap-x-2">
      ...
      case 'projects':
        ...
        return (
          <div className="mb-5" key="projects">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-3 text-black tracking-wider">Projects</h2>
            <div className="space-y-4">
                ...
                <div key={proj.id}>
                  <div className="flex justify-between items-baseline mb-0.5">
                    <div className="text-[14px] font-bold text-black flex items-center gap-2">
                      ...
                      {proj.link && (
                        <span className="font-normal italic text-[12px] text-blue-700 hover:underline">
      ...
      case 'certifications':
        ...
        return (
          <div className="mb-5" key="certifications">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-2.5 text-black tracking-wider">Certifications</h2>
      ...
      case 'achievements':
        ...
        return (
          <div className="mb-5" key="achievements">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-2.5 text-black tracking-wider">Achievements</h2>
      ...
      case 'languages':
        ...
        return (
          <div className="mb-5" key="languages">
            <h2 className="text-sm font-bold uppercase border-b border-black pb-0.5 mb-2 text-black tracking-wider">Languages</h2>
  ...
  return (
    <div className="text-black bg-white" style={{ fontFamily: layout.fontFamily || 'Times New Roman, serif', padding: `${layout.margins || 20}mm` }}>
