...
export default function MinimalTemplate() {
  ...
  const layout = data.layout || { fontFamily: 'Outfit, sans-serif', fontSize: 12, primaryColor: '#333333', lineSpacing: 1.6, margins: 24 };
  ...
  return (
    <div className="text-black bg-white" style={{ fontFamily: layout.fontFamily || 'Outfit, sans-serif', padding: `${layout.margins || 20}mm` }}>
